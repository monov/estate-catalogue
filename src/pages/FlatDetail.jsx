...
const FlatDetail = () => {
  ...
  async function askconvert(event) {
    if (event.target.value === "uzs") {
      ...
      setPricetext(
        formatstuff(
          Math.round(parseInt(data.conversion_rates["UZS"])) * flat.price
        )
      );
      let priceuzs =
        Math.round(parseInt(data.conversion_rates["UZS"])) * flat.price;
    ...
    <>
      ...
      <div className="fldt-main-body">
        ...
        <section>
          ...
          <Slider
            className={windowWidth < 450 ? "Slider mobile" : "Slider"}
            ref={sliderRef}
            {...settings}
          >
        ...
        <section className="buttons-wrapper-mobile">
          <div className="buttons-first-row">
            <div className="button-mobile p" onClick={goToSlide}>
              План
            </div>
            <a href="#bio" className="button-mobile">
              Описание
            </a>
          </div>
          <a href="#contactus" className="button-mobile second-row">
            Записаться на просмотр
          </a>
        </section>
        <div className="space"></div>
        <section className="fldt-bio" id="bio">
          ...
          <div className="fldt-moreinfo price">
            ...
            <div className="currency-2">
              <div className="cur-txt-2">
                {pricetext} {currency} -{" "}
                <span className="cur-txt-2-span">
                  {ratiotext} {currency}/m2
                </span>
              </div>
        ...
        <section className="contact-us" id="contactus">
          <div className="our-agent">
            ...
            <div className="our-agent-text">
              <p className="agent-name-p">Леонид Цой</p>
